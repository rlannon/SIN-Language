...
const std::vector<std::string> Lexer::keywords{ "alloc", "and", "array", "asm", "bool", "catch", "const", "def", "dynamic", "else", "float", "free", "if", "include", "int", "let", "long", "or", "pass", "ptr", "raw", "realloc", "return", "short", "sizeof", "static", "string", "struct", "try", "unsigned", "void", "while", "xor"};
